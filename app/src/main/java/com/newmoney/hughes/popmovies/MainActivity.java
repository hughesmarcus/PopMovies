...
import com.newmoney.hughes.popmovies.details.MovieDetailActivity;
import com.newmoney.hughes.popmovies.details.MovieDetailFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomBar.setOnTabSelectListener(new OnTabSelectListener() {
            ...
            public void onTabSelected(@IdRes int tabId) {
                ...
                if(tabId == R.id.tab_upcoming){
                    if (mSortBy.equals(FetchMoviesTask.FAVORITES)) {
                        getSupportLoaderManager().destroyLoader(FAVORITE_MOVIES_LOADER);
                    }
                    mSortBy = FetchMoviesTask.UPCOMING;
                    fetchMovies(mSortBy);
                }
            }
        });
